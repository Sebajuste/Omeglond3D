...
namespace OMGL3D
{
    namespace OGL3
    {
        OGL3Light::OGL3Light(const std::string & name) : CORE::CLight(name)
        {
        ...
        void OGL3Light::Enable(unsigned int canal)
        {
        ...
        void OGL3Light::Disable(unsigned int canal)
        {
