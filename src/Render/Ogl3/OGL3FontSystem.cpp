...
namespace OMGL3D
{
    namespace OGL3
    {
        OGL3FontSystem::OGL3FontSystem(const std::string & name) : FONT::IFont(name)
        {
        }

        OGL3FontSystem::~OGL3FontSystem()
        {
            glDeleteLists(_base, 256);
        }

        void OGL3FontSystem::LoadFont(const std::string & font_name)
        {
            _size = 12;
        ...
        void OGL3FontSystem::Draw(const std::string & text, const CORE::CColor & color)
        {
            glColor3fv(*color);
